...
public class PersonalizedActivity extends AppCompatActivity implements PreviewAdapter.PreviewListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PersonalizedActivity.this, CreateBlogActivity.class));
            }
        });*/
    }
